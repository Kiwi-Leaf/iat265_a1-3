...
public class Food extends Creatures {
	/*Theses are variables and methods are exclusive to this class. 
	  ...
	  Methods that are exclusive to this class are setTargetedColor() and setOriginalColor().
...
//		Graphics2D g2= (Graphics2D) g;
	...
	public boolean isEaten(Eel e) {
		if (this.getBoundary().intersects(e.getBoundary().getBounds2D())&&e.getBoundary().intersects(this.getBoundary().getBounds2D())) {
